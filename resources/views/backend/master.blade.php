...
{{--                            @endrole--}}
                            ...
                            @if(Auth::user()->hasRole('editor') || Auth::user()->hasRole('admin'))
                                <a class="nav-link" href="{{ route('product.manage') }}">View/Manage Product</a>
                            @endif
                        </nav>
                    </div>
                    ...
                    <div class="collapse" id="role" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="{{ route('role.index') }}">Add Role</a>
                            <a class="nav-link" href="{{ route('assign.users') }}"> Assign Role</a>
                            <a class="nav-link" href="{{ route('view.role') }}"> View/Manage Role</a>
                        </nav>
                    </div>
